<?php 
$json_id_file = file_get_contents('./lang/id_ID.json');
$json_id = json_decode($json_id_file);
$json_NL_file = file_get_contents('./lang/nl_NL.json');
$json_NL = json_decode($json_NL_file);
$language = 'id';
  ...
  <body>
    <nav class="navbar">
      <div class="container">
        ...
        <ul>
          <?php if($language == 'nl'): ?>
            <?php foreach($json_NL as $item): ?>
              <li><a href="#"><?php echo $item; ?></a></li>
            <?php endforeach; ?>
          <?php else: ?>
            <?php foreach($json_id as $item): ?>
              <li><a href="#"><?php echo $item; ?></a></li>
            <?php endforeach; ?>
          <?php endif; ?>
